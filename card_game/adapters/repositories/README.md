...
A `factory` deve, com base no valor de `AppSettings.REPOSITORY` retornar uma instância de uma sessão do banco selecionado (sqlite ou postgres) pronta para uso.
